...
Public Class Stockout
    ...
    Private Sub Stockout_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'get BONID 
        Try
            Dim selectSQLCMD As New SqlCommand("SELECT MAX(BonId) as lastID FROM StockOut", SQLCONN)
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles SubmitButton2.Click
        ...
        Else
            ...
            For row As Integer = 0 To DataGridView.Rows.Count - 1
                Dim InsertSQLCMD As New SqlCommand($"insert Into StockOut (bonID,ItemID,UserName,Date,Category,Type,ItemName,Unity,Quantity,Recipient,note)
                                        VALUES (@bonID,@ItemID,@UserName,@Date,@Category,@Type,@ItemName,@Unity,@Quantity,@Recipient,@note)", SQLCONN)
                With InsertSQLCMD
                    ...
                    .Parameters.AddWithValue("@Recipient", Recipienttextbox.Text)
                    .Parameters.AddWithValue("@note", NoteTextBox.Text)
    ...
    Private Sub QtyNumericUpDown_ValueChanged(sender As Object, e As EventArgs) Handles QtyNumericUpDown.ValueChanged
